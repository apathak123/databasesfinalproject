...
<h3>Bar Query 2</h3>
want to know the most profitable beer that you sell?<br/>
  ...
  <input type="submit" value="Submit">
     ...
     try{
    	//Get the database connection
			...
			if (bar_name!=null)
			{
			String str = "SELECT DISTINCT Sells.bar_name, Beer.beer_name,(Sells.price_per_beer - Beer.price_per_beer )as profit FROM Sells,Beer WHERE Sells.bar_name = '"+bar_name+"' AND Sells.beer_name = Beer.beer_name ORDER BY profit DESC";
			...
			<thead>
			<tr><td>bar_name</td><td>beer_name</td><td>profit</td></tr>
			</thead>
			<tbody>
		<% while (result.next()) 
		{%>
			...
			<td><%out.print(result.getString("profit")); %></td>
			</tr>
